...
This Project Contains XWorm V5.6

## Tutorial
- Turn off antivirus (or it will be deleted and cant run)
- Download from release to your computer.
- Extract the Project to a Folder.
- Run the .exe

<h1>I AM NOT RESPOSIBLE FOR ANY OF YOUR ACTIONS, LEGAL OR ILLEGAL THIS IS FOR EDUCATIONAL PURPOSES ONLY</h1>
